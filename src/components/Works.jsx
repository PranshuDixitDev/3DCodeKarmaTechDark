...
const ProjectCard = ( 
    ...
    return (
      <motion.div
        variants={fadeIn("up", "spring", index * 0.5, 0.075)}>
        <Tilt 
          opitions={{
            max: 45,
            scale: 1,
        ...
        >
          <div className='relative w-full h-[230px]'>
            ...
            <div className='absolute inset-0 flex
              justify-end m-3 card-img_gover'>
              <div 
                onClick={() => window.open
  ...
  return (
    ...
    <motion.div variants={textVariant()}>
      ...
      <div className='w-full flex'>
        ...
        >
          Following projets showcases my skills and Experience through real-world examples of my work ,
